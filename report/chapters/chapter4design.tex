...
\subsection{Bằng chứng kết quả chạy thực nghiệm}
Để chứng minh tính thực tiễn và kiểm thử hoạt động của hệ thống, nhóm đã lưu lại các hình ảnh bằng chứng thực nghiệm về phần cứng thực tế, cơ sở dữ liệu trên Cloud và tin nhắn cảnh báo gửi về điện thoại:

\insertimage{images/prototypephoto.png}{Ảnh chụp thực tế sản phẩm nguyên mẫu trạm quan trắc chất lượng không khí}{fig:prototypephoto}
Hình \ref{fig:prototypephoto} là ảnh chụp thực tế nguyên mẫu trạm đo sau khi lắp ráp hoàn thiện bo mạch PCB, ESP32, màn hình OLED và các cảm biến trong hộp nhựa mica bảo vệ có tích hợp quạt lấy mẫu khí.
...
\begin{itemize}
    ...
    \item \textbf{Đo tại khu vực gửi xe (Outdoor)}: Đặt tại khu vực nhà xe lộ thiên, chịu ảnh hưởng trực tiếp của đợt nắng nóng cực đại tháng 6 tại Hà Nội.
\end{itemize}
...
\subsubsection{Kết quả đo đạc trong phòng (Trạm 1)}
...
\subsubsection{Kết quả đo đạc ngoài trời khu vực nhà xe (Trạm 2)}
