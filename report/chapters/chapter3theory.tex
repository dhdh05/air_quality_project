...
\insertimage{images/cambienbui.jpg}{Sơ đồ nguyên lý cấu trúc cảm biến bụi Sharp GP2Y1010AU0F}{fig:sharpinternal}
...
\item ESP32 kéo chân điều khiển LED (\texttt{GP2Y\_LED\_PIN}) xuống mức thấp (Active LOW) để bật IRED hồng ngoại.
\item Chờ đúng \textbf{$0.28ms$} ($280\mu s$) để luồng hạt bụi đi qua buồng đo tán xạ ánh sáng hồng ngoại lên bề mặt Phototransistor.
\item Thực hiện đọc giá trị điện áp ADC từ chân cảm biến (\texttt{GP2Y\_PIN}) (mất khoảng $40\mu s$ đối với ESP32).
\item Chờ tiếp \textbf{$0.04ms$} ($40\mu s$) để hoàn thành cửa sổ đo $0.32ms$.
\item Kéo chân điều khiển LED lên mức cao (HIGH) để tắt IRED hồng ngoại.
\item Chờ hết chu kỳ \textbf{$9.68ms$} trước khi thực hiện lần lấy mẫu tiếp theo (tổng chu kỳ xung $10ms$).
